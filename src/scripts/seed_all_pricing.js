...
const META_TEMPLATE_PRICING = [
  ...
  { category: "utility", country: "GB", rate: 0.0201, markup_percent: 10 }, // ✅ FIXED: was 0.0233 → £0.0159 ≈ $0.0201
  {
    ...
    rate: 0.0201,
    markup_percent: DEFAULT_MARKUP_PERCENT,
  }, // ✅ FIXED: was 0.0337 → £0.0159 ≈ $0.0201
  ...
  { category: "utility", country: "ID", rate: 0.0043, markup_percent: 10 }, // ✅ FIXED: was 0.005 → Rp 356.65 ≈ $0.0043 (approx, IDR billing)
  {
    ...
    rate: 0.0043,
    markup_percent: DEFAULT_MARKUP_PERCENT,
  }, // ✅ FIXED: was 0.03 → Rp 356.65 ≈ $0.0043
  ...
  { category: "utility", country: "DE", rate: 0.0495, markup_percent: 10 }, // ✅ FIXED: was 0.06 → €0.0456 ≈ $0.0495
  {
    ...
    rate: 0.0495,
    markup_percent: DEFAULT_MARKUP_PERCENT,
  }, // ✅ FIXED: was 0.0867 → €0.0456 ≈ $0.0495
  ...
  { category: "utility", country: "ES", rate: 0.018, markup_percent: 10 }, // ✅ FIXED: was 0.027 → €0.0166 ≈ $0.0180
  {
    category: "authentication",
    country: "ES",
    rate: 0.018,
    markup_percent: DEFAULT_MARKUP_PERCENT,
  }, // ✅ FIXED: was 0.0391 → €0.0166 ≈ $0.0180
  ...
  { category: "utility", country: "IT", rate: 0.0269, markup_percent: 10 }, // ✅ FIXED: was 0.0304 → €0.0248 ≈ $0.0269
  {
    ...
    rate: 0.0269,
    markup_percent: DEFAULT_MARKUP_PERCENT,
  }, // ✅ FIXED: was 0.0439 → €0.0248 ≈ $0.0269
...
const AI_MODEL_PRICING = [
  ...
  },
  {
    model: "gpt-5.4",
    description:
      "Flagship GPT-5.4 model — best intelligence at scale for agentic, coding, and professional workflows",
    recommended_for: "output",
    category: "premium",
    input_rate: 2.5, // $2.50 per 1M input tokens (OpenAI official)
    output_rate: 15.0, // $15.00 per 1M output tokens (OpenAI official)
    markup_percent: DEFAULT_MARKUP_PERCENT,
    usd_to_inr_rate: DEFAULT_USD_TO_INR,
    is_active: true,
  },
  ...
  // ──────────────────  MID-TIER ──────────────────
  {
    model: "gpt-4.1",
    description:
      "Recommended production model — strong coding, instruction following, 1M context window",
  ...
  },
  {
    ...
    recommended_for: "both",
    category: "mid-tier",
    input_rate: 0.75, // $0.75 per 1M input tokens (OpenAI official)
    output_rate: 4.5, // $4.50 per 1M output tokens (OpenAI official)
    markup_percent: DEFAULT_MARKUP_PERCENT,
    usd_to_inr_rate: DEFAULT_USD_TO_INR,
    is_active: true,
  },
  ...
  },
  {
    ...
    recommended_for: "input",
    category: "budget",
    input_rate: 0.2, // $0.20 per 1M input tokens (OpenAI official)
    output_rate: 1.25, // $1.25 per 1M output tokens (OpenAI official)
    markup_percent: DEFAULT_MARKUP_PERCENT,
    usd_to_inr_rate: DEFAULT_USD_TO_INR,
    is_active: true,
  },
  ...
  },
  {
    model: "o4-mini",
    description:
      "Next-gen reasoning model for complex decision making — best-value reasoning model",
    recommended_for: "both",
    category: "reasoning",
    input_rate: 1.1, // $1.10 per 1M input tokens  ✅ correct
    output_rate: 4.4, // $4.40 per 1M output tokens ✅ correct
