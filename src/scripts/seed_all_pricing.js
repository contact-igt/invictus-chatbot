 ...
 * with NO platform fees (markup_percent = 0)
 *
 ...
 *
 * All rates are BASE RATES without any platform markup.
...
const META_TEMPLATE_PRICING = [
  ...
  { category: "service", country: "IN", rate: 0.0, markup_percent: 0 }, // Free service conversations

  // United States (US)
  { category: "marketing", country: "US", rate: 0.025, markup_percent: 0 },
  { category: "utility", country: "US", rate: 0.015, markup_percent: 0 },
  {
    category: "authentication",
    country: "US",
    rate: 0.0135,
  ...
  { category: "service", country: "US", rate: 0.0, markup_percent: 0 },
  ...
  { category: "service", country: "GB", rate: 0.0, markup_percent: 0 },

  // United Arab Emirates (AE)
  { category: "marketing", country: "AE", rate: 0.0384, markup_percent: 0 },
  { category: "utility", country: "AE", rate: 0.0169, markup_percent: 0 },
  {
    category: "authentication",
    country: "AE",
    rate: 0.0183,
  ...
  { category: "service", country: "AE", rate: 0.0, markup_percent: 0 },

  // Saudi Arabia (SA)
  { category: "marketing", country: "SA", rate: 0.0325, markup_percent: 0 },
  { category: "utility", country: "SA", rate: 0.0143, markup_percent: 0 },
  {
    category: "authentication",
    country: "SA",
    rate: 0.0155,
  ...
  { category: "service", country: "SA", rate: 0.0, markup_percent: 0 },

  // Brazil (BR)
  { category: "marketing", country: "BR", rate: 0.0625, markup_percent: 0 },
  { category: "utility", country: "BR", rate: 0.008, markup_percent: 0 },
  {
    category: "authentication",
    country: "BR",
    rate: 0.0315,
  ...
  { category: "service", country: "BR", rate: 0.0, markup_percent: 0 },

  // Indonesia (ID)
  { category: "marketing", country: "ID", rate: 0.0411, markup_percent: 0 },
  { category: "utility", country: "ID", rate: 0.005, markup_percent: 0 },
  { category: "authentication", country: "ID", rate: 0.03, markup_percent: 0 },
  { category: "service", country: "ID", rate: 0.0, markup_percent: 0 },

  // Mexico (MX)
  { category: "marketing", country: "MX", rate: 0.0436, markup_percent: 0 },
  { category: "utility", country: "MX", rate: 0.0056, markup_percent: 0 },
  {
    category: "authentication",
    country: "MX",
    rate: 0.0263,
  ...
  { category: "service", country: "MX", rate: 0.0, markup_percent: 0 },

  // Germany (DE)
  { category: "marketing", country: "DE", rate: 0.1365, markup_percent: 0 },
  { category: "utility", country: "DE", rate: 0.06, markup_percent: 0 },
  {
    category: "authentication",
    country: "DE",
    rate: 0.0867,
  ...
  { category: "service", country: "DE", rate: 0.0, markup_percent: 0 },

  // Spain (ES)
  { category: "marketing", country: "ES", rate: 0.0615, markup_percent: 0 },
  { category: "utility", country: "ES", rate: 0.027, markup_percent: 0 },
  {
    category: "authentication",
    country: "ES",
    rate: 0.0391,
  ...
  { category: "service", country: "ES", rate: 0.0, markup_percent: 0 },

  // Italy (IT)
  { category: "marketing", country: "IT", rate: 0.0691, markup_percent: 0 },
  { category: "utility", country: "IT", rate: 0.0304, markup_percent: 0 },
  {
    category: "authentication",
    country: "IT",
    rate: 0.0439,
  ...
  { category: "service", country: "IT", rate: 0.0, markup_percent: 0 },

  // Nigeria (NG)
  { category: "marketing", country: "NG", rate: 0.0516, markup_percent: 0 },
  { category: "utility", country: "NG", rate: 0.0066, markup_percent: 0 },
  {
    category: "authentication",
    country: "NG",
    rate: 0.0295,
  ...
  { category: "service", country: "NG", rate: 0.0, markup_percent: 0 },

  // South Africa (ZA)
  { category: "marketing", country: "ZA", rate: 0.038, markup_percent: 0 },
  { category: "utility", country: "ZA", rate: 0.0049, markup_percent: 0 },
  {
    category: "authentication",
    country: "ZA",
    rate: 0.0202,
  ...
  { category: "service", country: "ZA", rate: 0.0, markup_percent: 0 },

  // Global Fallback (default if no specific country rule)
  { category: "marketing", country: "Global", rate: 0.075, markup_percent: 0 },
  { category: "utility", country: "Global", rate: 0.015, markup_percent: 0 },
  {
    category: "authentication",
    country: "Global",
    rate: 0.015,
  ...
  { category: "service", country: "Global", rate: 0.0, markup_percent: 0 },
];
  ...
  for (const rule of META_TEMPLATE_PRICING) {
    try {
      ...
      if (!existing) {
        ...
        // Update existing record to ensure markup is 0
        await existing.update({ rate: rule.rate, markup_percent: 0 });
        console.log(
  ...
  for (const model of AI_MODEL_PRICING) {
    try {
      ...
      if (!existing) {
        ...
        // Update existing record to ensure markup is 0 and rates are current
...
const seedAllPricing = async () => {
  ...
  console.log("       MASTER PRICING SEED SCRIPT - NO PLATFORM FEES");
  console.log(
    "═══════════════════════════════════════════════════════════════",
  );
  ...
  try {
    ...
    console.log("\n📝 Notes:");
    console.log(
      "   • All markup_percent values are set to 0 (no platform fees)",
    );
